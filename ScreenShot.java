...
public class ScreenShot {
	...
	public static String capture(WebDriver driver, String fileSavePath, String fileName) throws IOException {
		Calendar calendar = Calendar.getInstance();//to get every image with current date and time
		SimpleDateFormat formatar= new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss_SSS");//set current date format
